...
public class RhyImage3DSwitchView extends ViewGroup {
        ...
        if (z || this.forceToRelayout) {
            ...
            if (i5 >= 0 && i5 < this.mCount) {
                ...
                for (int i8 = 0; i8 < 5; i8++) {
                    ...
                    rhyImage3DView.setOnClickListener(new View.OnClickListener() { // from class: cn.com.heaton.shiningmask.ui.widget.image3d.RhyImage3DSwitchView.1
    ...
    private void beginScroll(int i, int i2, int i3, int i4, final int i5) {
        ...
        invalidate();
        handler.postDelayed(new Runnable() { // from class: cn.com.heaton.shiningmask.ui.widget.image3d.RhyImage3DSwitchView.2
