...
public class LedView1 extends ViewGroup {
    ...
    public LedView1(Context context) {
        super(context);
        this.widthCount = 5;
        this.heightCount = 10;
        this.pointMargin = 1;
        ...
        this.handler = new Handler() { // from class: cn.com.heaton.shiningmask.ui.widget.LedView1.1
            @Override // android.os.Handler
            public void handleMessage(Message message) {
                if (message.what == 1) {
                    LedView1.this.topAnimRight();
                } else if (message.what == 2) {
                    LedView1.this.textLeftMove();
                } else if (message.what == 3) {
                    LedView1.this.topAnimLeft();
                } else if (message.what == 4) {
                    LedView1.this.textRightMove();
                }
    ...
    public LedView1(Context context, AttributeSet attributeSet) {
    ...
    public LedView1(Context context, AttributeSet attributeSet, int i) {
    ...
    public void topAnimRight() {
        ...
        Lb3:
            ...
            return
        */
        throw new UnsupportedOperationException("Method not decompiled: cn.com.heaton.shiningmask.ui.widget.LedView1.topAnimRight():void");
    }

    private LedItemView1 getLedItemView1(int i, int i2) {
        int i3 = (i * 12) + i2;
        LogUtil.d("index:" + i3);
        return (LedItemView1) getChildAt(i3);
    }
    ...
    public void setImageData(int[] iArr) {
        ...
        for (int i2 = 0; i2 < 36; i2++) {
            for (int i3 = 0; i3 < 12; i3++) {
                LedItemView1 ledItemView1 = getLedItemView1(i2, i3);
                int i4 = iArr[i];
                if (ledItemView1 != null) {
                    ...
                    int i6 = (i4 >> 8) & 255;
                    int i7 = (i4 >> 16) & 255;
                    LogUtil.d("r:" + i5 + " g:" + i6 + " b:" + i7);
                    ledItemView1.setPaint(Color.rgb(i5, i6, i7));
                    ledItemView1.postInvalidate();
                }
                i++;
            }
        ...
        for (int i = 0; i < this.imageData.length; i++) {
            for (int i2 = 0; i2 < 9; i2++) {
                ...
                if (ledItemView1 != null) {
                    if (i3 == 1) {
                        ledItemView1.setChecked(true);
                        ledItemView1.setPaint(this.selectedColor1);
                    } else if (i3 == 2) {
                        ledItemView1.setChecked(true);
                        ledItemView1.setPaint(this.selectedColor2);
                    } else if (i3 == 3) {
                        ledItemView1.setChecked(true);
                        ledItemView1.setPaint(this.selectedColor3);
                    } else {
    ...
    class MyTimerTask1 extends TimerTask {
        ...
        public void run() {
            ...
            message.what = 1;
            LedView1.this.handler.sendMessage(message);
        }
    }
    ...
    public void setSaveDiyData(List<Integer> list, boolean z) {
        ...
        if (list != null && list.size() == (childCount = getChildCount())) {
            for (int i = 0; i < childCount; i++) {
                LedItemView1 ledItemView1 = (LedItemView1) getChildAt(i);
                ledItemView1.setPaint(list.get(i).intValue());
                ledItemView1.postInvalidate();
            }
        }
    }
