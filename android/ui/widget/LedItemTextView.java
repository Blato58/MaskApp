...
public class LedItemTextView extends View {
    ...
    public LedItemTextView(Context context) {
        super(context);
        init(0, 1.0f);
    }

    public LedItemTextView(Context context, AttributeSet attributeSet) {
        super(context, attributeSet);
        init(0, 1.0f);
    }

    public LedItemTextView(Context context, AttributeSet attributeSet, int i) {
