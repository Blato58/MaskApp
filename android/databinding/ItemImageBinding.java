...
public final class ItemImageBinding implements ViewBinding {
    ...
    private ItemImageBinding(RelativeLayout relativeLayout, ImageView imageView, RelativeLayout relativeLayout2) {
    ...
    public static ItemImageBinding bind(View view) {
        ...
        if (imageView != null) {
            ...
            return new ItemImageBinding(relativeLayout, imageView, relativeLayout);
        }
